...
\begin{table}[htbp]
	...
	\begin{center}
		\begin{tabular}{ c c }
			...
			avg\_task\_time & Average time span from enqueueing until \\
			& execution of tasks \\
			\hline
		\end{tabular}
		\label{tab4}
