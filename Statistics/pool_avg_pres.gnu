set terminal pngcairo nocrop enhanced size 1500,1000 font ",8"
set output 'pool_avg.pres.png'
set title 'Idle and completion time comparison over multiple threads' font ",20"
